...
public class Matcher implements ActionListener {
	...
	private void judgment(JButton e){
		if (judge == 1)
			...
			if (saved.equals(e)){
				...
				int savedRowSlot = 0; int savedColumnSlot = 0; int newRowSlot = 0; int newColumnSlot = 0;
	...
	//Custom function to figure out the rows, columns, and the array.
	private void determineGrid(){
		...
		try {
			...
			while((line = buffReader2.readLine()) != null){
				...
				boolean input1 = false;boolean input2 = false;
